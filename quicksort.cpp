...
void partition(vector <int>  ar, vector<int>& frontVector, vector<int>& backVector) {
...
void quickSort(vector<int>&  ar, int ar_size) {
	...
	partition(ar,frontVector,backVector);
	quickSort(frontVector,frontVector.size());
	quickSort(backVector,backVector.size());
